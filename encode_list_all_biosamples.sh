...
url="https://www.encodeproject.org/search/?type=Biosample&limit=all"
echoerr "Querying the url:\n" $url
echoerr "Saving results in encode_biosamples.json"
curl -H "Accept: application/json" $url > encode_biosamples.json
